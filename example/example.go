...
func main() {
	...
	// You can create a key pair externally and provide it instead which is
	// what you probably want to do. Otherwise, a new key will be genereated
	...
	// your services that have the public key can verify that the signature of a
	// token is valid and read the data in one shot via the Decode function.
	// Let's extract the data into a new instance of our TokenData struct
